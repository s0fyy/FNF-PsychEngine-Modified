...
class Paths
{
	...
	public static function getPerth(file:String, ?type:AssetType = TEXT, ?library:Null<String> = null, ?modsAllowed:Bool = false):String
		{
			#if MODS_ALLOWED
			if(modsAllowed)
			{
	...
	inline public static function getNormPath(file:String = '')
	{
		return 'assets/$file';
	}
	...
	inline static public function dtxt(key:String, ?library:String)
	{
		return getPerth('songs/$key.txt', TEXT, library);
	}
	...
	{
		return getPerth('songs/$key.json', TEXT, library);
	}
	...
	inline static public function ejson(key:String, ?library:String)
	{
		return getPerth('songs/$key.json', TEXT, library);
	}
