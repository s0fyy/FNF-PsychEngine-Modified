...
class Bar extends FlxSpriteGroup
{
	...
	public function new(x:Float, y:Float, image:String = 'menus/playstate/healthBar', valueFunction:Void->Float = null, boundX:Float = 0, boundY:Float = 1)
		{
		super(x, y);
		...
		bg = new FlxSprite().loadGraphic(Paths.image('menus/playstate/$image'));
		...
		if(ClientPrefs.data.coloredTime) leftBar.color = FlxColor.fromRGB(PlayState.instance.dad.healthColorArray[0], PlayState.instance.dad.healthColorArray[1], PlayState.instance.dad.healthColorArray[2]);
